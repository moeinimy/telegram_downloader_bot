...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        if result.platform == Platform.YOUTUBE:
        ...
        elif result.platform == Platform.DEEZER:
            from handlers import deezer_handler

            await deezer_handler.handle_url(update, context, result)
            ...
            await msg.reply_text(t(msg.chat_id, "🤔 لینک رو نشناختم. یوتوب / اینستا / اسپاتیفای / ساندکلاد / دیزر / تیک‌تاک / پینترست ساپورت می‌شه."))
    except Exception as e:
