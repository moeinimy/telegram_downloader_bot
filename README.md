...
**📩 اینستاگرام دایرکت** — `/igdirect`. کاربر اکانتش رو یه‌بار با یه کد وصل می‌کنه، بعد هرچی تو دایرکت اینستاگرام share کنه همین‌جا دانلودشده تحویل می‌گیره. دو مسیر مستقل داره (وب‌هوک رسمی متا، و پولینگ به‌عنوان پشتیبان) که پشت یه اینترفیس‌ان و اگه اولی بیفته دومی خودکار بیدار می‌شه.
...
web/webhook.py          اندپوینت HTTPS وب‌هوک اینستاگرام
deploy/manage.sh        اسکریپت نصب و مدیریت
deploy/selfcheck.py     تست‌های آفلاین (امضای وب‌هوک، dedup، pairing، i18n)
```
